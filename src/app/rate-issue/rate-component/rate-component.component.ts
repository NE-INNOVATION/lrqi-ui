...
export class RateComponent implements OnInit {
  ...
  disableFirst() {
    return (
      this.coverageForm.value.bi == "" ||
      this.coverageForm.value.pd == "" ||
      this.coverageForm.value.med == ""
    );
  }

  disableRate() {
    return (
      this.coverageForm.value.comp == "" ||
      this.coverageForm.value.col == "" ||
      this.coverageForm.value.rerim == ""
    );
  }
